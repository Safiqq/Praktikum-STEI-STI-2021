...
boolean isAnagram(Word string1, Word string2) {
	...
	for (i = 0; i < stringLength(string1.TabWord); i++) {
		if ('A' <= string1.TabWord[i] && string1.TabWord[i] <= 'Z') alfabet1[(int)string2.TabWord[i] - 65]++;
		else if ('a' <= string1.TabWord[i] && string1.TabWord[i] <= 'z') alfabet1[(int)string1.TabWord[i] - 97]++;
	}
	for (i = 0; i < stringLength(string2.TabWord); i++) {
		if ('A' <= string2.TabWord[i] && string2.TabWord[i] <= 'Z') alfabet2[(int)string2.TabWord[i] - 65]++;
		else if ('a' <= string2.TabWord[i] && string2.TabWord[i] <= 'z') alfabet2[(int)string2.TabWord[i] - 97]++;
	}
	for (i = 0; i < 26; i++) {
