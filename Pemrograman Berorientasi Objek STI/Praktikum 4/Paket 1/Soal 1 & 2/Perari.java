...
public class Perari extends Car {// Jangan lupa tambahkan kata kunci untuk melakukan polymorphism antar kelas
    ...
    public Perari(int numberOfWheels, int engineCapacity, int averageSpeed, Boolean isInsuranced) {
        // Konstruktor
        // averageSpeed merupakan nilai kecepatan rata-rata dari perari dalam satuan
        // km/h
    ...
    public String printDescription() {
        ...
        // Apabila isInsurance true, maka mengembalikan: "Mobil ini memiliki a roda
        // dengan kapasitas mesin b cc, memiliki kecepatan rata-rata c km/h, dan sedang
        // dalam perlindungan asuransi", dimana a adalah numberOfWheels, b adalah
        // engineCapacity dan c adalah averageSpeed
        // Apabila isInsurance false, maka mengembalikan: "Mobil ini memiliki a roda
        // dengan kapasitas mesin b cc, memiliki kecepatan rata-rata c km/h, dan sedang
        // tidak dalam perlindungan asuransi", dimana a adalah numberOfWheels, b adalah
        // engineCapacity dan c adalah averageSpeed
        return "Mobil ini memiliki " + getNumberOfWheels() + " roda dengan kapasitas mesin " + getEngineCapacity()
                + " cc, memiliki kecepatan rata-rata " + averageSpeed + " km/h, dan sedang "
                + (isInsuranced ? "" : "tidak ") + "dalam perlindungan asuransi";
    }
}
